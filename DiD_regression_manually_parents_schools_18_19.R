...
two_data<-model_data%>%
  ...
  ## ...or in this case voted in 2018 or 2019
  group_by(year)%>%
...
#   mutate(no_move_new_poll_loc_2019 = (no_move_new_poll_loc==T & year>2018))
# 
# dvar<-'no_move_new_poll_loc_2019'
# 
...
voters_parents_two_data_2018 <- voters_parents_two_data %>%
  filter(year == 2018) %>%
...
voters_parents_two_data <- voters_parents_two_data %>%
  left_join(voters_parents_two_data_2018, by = "LALVOTERID", suffix = c("", "_2018"))%>%
  mutate(
    ...
    CommercialData_OccupationIndustry = CommercialData_OccupationIndustry_2018,
...
writeLines(chars, con = file(paste0("C:/Users/natha/Desktop/Polling Places DiD/second_submission_diff_in_diffs/",
                                    "parent_school_t_test_18_19_3_2_26.txt"))
)
...
writeLines(chars, con = file(paste0("C:/Users/natha/Desktop/Polling Places DiD/second_submission_diff_in_diffs/",
                                    "parent_school_glm_no_covars_18_19_3_3_26.txt"))
)
#estimate ATT
...
writeLines(chars, con = file(paste0("C:/Users/natha/Desktop/Polling Places DiD/second_submission_diff_in_diffs/",
                                    "parent_school_glm_no_covars_ATT_18_19_3_3_26.txt"))
)
...
writeLines(chars, con = file(paste0("C:/Users/natha/Desktop/Polling Places DiD/second_submission_diff_in_diffs/",
                                    "parent_school_glm_covars_18_19_3_3_26.txt"))
)
#estimate ATT
...
writeLines(chars, con = file(paste0("C:/Users/natha/Desktop/Polling Places DiD/second_submission_diff_in_diffs/",
                                    "parent_school_glm_covars_ATT_18_19_3_3_26.txt"))
)
