...
# voters_parents_model_data_post_17_chng['parent_new_poll_school'] <- 
#   sapply(voters_parents_model_data_post_17_chng['parent_new_poll_school'],as.numeric)
...
trials<-c(nrow(one_year[one_year$parent_new_poll_school==0,]),
          nrow(one_year[one_year$parent_new_poll_school==1,]))
