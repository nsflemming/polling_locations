...
FVEpath = 'C:/Users/natha/Desktop/Polling Places DiD/data/Raw FVEs 2020/'
FVEfiles = [i for i in os.listdir(FVEpath) if os.path.isfile(os.path.join(FVEpath,i)) and
         ...
         'FVE' in i]  # include file if it has 20191028.txt in its name
...
for FVE in FVEfilepaths:
    ...
    ## create path
    savepath = 'C:/Users/natha/Desktop/Polling Places DiD/data/FVEs for geocode/'
